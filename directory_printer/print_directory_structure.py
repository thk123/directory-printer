...
def _build_directory_structure_output(directory_structure:DirectoryStructure, current_indentation: int):
    lines: list[str] = []
    ...
    for subdirectory in directory_structure.subdirectories:
        subdirectory_lines = _build_directory_structure_output(subdirectory, current_indentation + 1)
        lines.extend(subdirectory_lines)
    return lines


def build_directory_structure_output(directory_structure:DirectoryStructure) -> list[str]:
    '''
